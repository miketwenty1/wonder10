        ...
        app.init_resource::<ApiPollingTimer>()
            ...
            .add_systems(
                ...
                tick_api_receive_timer.run_if(in_state(CommsApiState::SetName).or_else(
                    in_state(CommsApiState::Move).or_else(in_state(CommsApiState::BlockDetails)),
                )),
            )
            .add_systems(
                Update,
            ...
            .add_systems(Update, api_send_player_move)
            .add_systems(Update, api_request_blockchain_block)
            .add_systems(
                Update,
