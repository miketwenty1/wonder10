...
pub fn spawn_qr_code(
    ...
    let code = QrCode::with_version(invoice_data.invoice.to_string().to_ascii_uppercase(), Version::Normal(9), EcLevel::L).unwrap();
...
pub fn update_qr_code(
    ...
    egui::Window::new(format!("BTC Invoice for Height {}", player_location.0)).show(egui_context.ctx_mut(), |ui| {
